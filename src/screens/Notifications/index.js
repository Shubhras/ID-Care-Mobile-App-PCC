        ...
        >
            <View style={styles.mainWrapper}>
                ...
                <FlatList
                    ...
                    renderItem={({ item }) => (
                        <Pressable onPress={() => { }} style={[styles.notificationCard, { backgroundColor: item.read_status == "YES" && Colors.white }]} >
                            <View style={styles.row}>
                                <CustomText style={styles.statusText}>{item?.message}</CustomText>
                                <Pressable onPress={() => { navigation.navigate('PatientHistoryScreen', { care_unit_id: item?.care_unit_id, patient_id: item?.patient_id }) }}>
