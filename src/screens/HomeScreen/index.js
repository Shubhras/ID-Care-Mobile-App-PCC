...
import { CareUnit, LogoutAPI, Notification, patientListExisting } from "../../auth/auth";
                    ...
                    <View
                     ...
                     style={[styles.cardContainer, { backgroundColor: Colors.white }]}>
                            ...
                            right={
                                <View>{notificationCount > 0 &&
                                    <View style={styles.notificatonDot}>
                                        <CustomText style={styles.notificatonText}>{notificationCount}</CustomText>
                                    </View>}
                                    <Image
                        ...
                        <View style={styles.textView}>
                            <CustomText style={styles.listTitle}>Select Care Unit First To List Patients</CustomText>
                        </View>


                        <Pressable style={styles.CareUnitButton} onPress={() => setModalVisible(true)}>
                            <CustomText
                                numberOfLines={1} style={styles.careUnitButtonText}>
                        ...
                        <View style={styles.textView}>
                            <CustomText style={styles.listTitle}>Search Existing Patient</CustomText>
                        </View>
                        <TextInput
