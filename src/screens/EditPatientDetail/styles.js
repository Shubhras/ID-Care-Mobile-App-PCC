...
import { FONT_SIZE_LG, FONT_SIZE_MD, FONT_SIZE_SM, OPEN_SANS_BOLD, OPEN_SANS_MEDIUM, OPEN_SANS_REGULAR, SCREEN_HEIGHT, SCREEN_WIDTH, STANDARD_BORDER_RADIUS, STANDARD_SPACING, STANDARD_FLEX, STANDARD_TEXT_INPUT_HEIGHT } from '../../constants/Constants';
...
export default StyleSheet.create({
    ...
    optionRow: {
        flexDirection: 'row', columnGap: scale(5), width: SCREEN_HEIGHT * 0.1,
    },
    rowIdWrapper: {
        height: STANDARD_TEXT_INPUT_HEIGHT * 0.9,
        borderRadius: STANDARD_BORDER_RADIUS,
