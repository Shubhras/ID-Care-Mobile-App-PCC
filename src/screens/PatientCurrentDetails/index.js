      ...
      >
        ...
        >
          ...
          >
            <View style={styles.listContainer}>
              <View style={styles.rowWrapper}>
                ...
                <CustomText
                  style={[styles.valueText, { color: Colors.bluishPurple }]}
                  numberOfLines={1}
                >
                  {detail?.patient_id}
                </CustomText>
          ...
          <View style={styles.bottomWrapper}>
            <CustomText
              style={[styles.textBottomTitle, { color: Colors.white }]}
            >
          ...
          {!isEdit && user?.login_role === 'Md Steward' && (
            <View style={styles.editRow}>
              ...
              <View
                style={[
                  styles.newTtitleValueWrapper,
                  { backgroundColor: Colors.greyLightest },
                ]}
              >
                <CustomText
                  style={[
                    styles.newTtitleValue,
          ...
          <View style={styles.editRow}>
            ...
            <Pressable
              style={styles.newTtitleValueWrapper}
              onPress={
                !isEdit ? () => setInitialDxModalVisible(true) : undefined
              }
            >
              <CustomText
                style={[
              ...
              >
                {selectedInitialDx ? selectedInitialDx : '*CAUTI-NHSN'}
              </CustomText>
              {!isEdit && (
          ...
          <View style={styles.editRow}>
            ...
            <Pressable
              style={styles.newTtitleValueWrapper}
              onPress={
                !isEdit ? () => setInitialRxModalVisible(true) : undefined
              }
            >
              <CustomText
                style={[
              ...
              >
                {selectedInitialRx ? selectedInitialRx : 'Cephalexin'}
              </CustomText>
              {!isEdit && (
                <View style={styles.icon}>
                  <Icons
            ...
            <View style={styles.newTtitleValueWrapper}>
              ...
              {!isEdit && (
                <View style={styles.counterButtonView}>
                  ...
                  <CustomText
                    style={[styles.newTtitleValue, { color: Colors.black }]}
                  >
                    {count}
                  </CustomText>
          ...
          <View style={styles.additionalWrapper}>
            <CustomText style={styles.newTtitleSub}>
              Additional Comment
            </CustomText>
            <Pressable
              style={styles.selectOptionInput}
              onPress={
                !isEdit ? () => setAdditionalModalVisible(true) : undefined
              }
            >
              <CustomText
                style={[
                  styles.mailButtonText,
                  { color: Colors.textLowContrast },
                ]}
                numberOfLines={1}
              >
            ...
            {isEdit ? (
              <Pressable
                ...
                onPress={() => setMailModalVisible(true)}
              >
